# Morphchecker     
Система обнаружения и коррекции морфологических ошибок для корпуса эритажного русского языка Russian Learner Corpora
...
### Основной алгоритм
1. Чтение файлов. Формирование словарей {лемма:[морфемы]}, {лемма:[алломорфы корня]}, {окончание:[граммемы]}, {лемма:[правила]}.
